...
## Objective
Initially I wanted to create a smart garden, but due to hardware delay and eventual cancellation, I had to create something else. Our lecturer; [Fredrik ](https://www.youtube.com/channel/UCdrHIhg_z9psywqLT6HKhRg), shared with us; the students, several project inspiration .  One of the project ideas inspired me to create the smart IoT connected lake.
